...
`modn` is a mobile application that helps event teams manage their gatherings and validate attendee tickets through QR codes quickly and reliably, while showing the ticket status instantly on screen.
